...
router.delete('/:user_id/:product_id', reviewController.deleteReviewByUserIdAndProductId);
...
router.get('/:product_id/:user_id', reviewController.getReviewsByProductAndUser);
